                            ...
                            <div class="form-container">
                                <form method="POST" action="update.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama" name="nama" required class="form-control" value="<?php echo $row['nama']; ?>">
                                    </div>

                                    <table class="tabel">
                                        <tr>
                                            <th><label for="nik">NIK</label></th>
                                            <td><input type="text" id="nik" name="nik" required class="form-control special" value="<?php echo $row['nik']; ?>"></td>
                                            <td class="special2">
                                                <table class="uagama">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div class="radio-group">
                                                    <label><input type="radio" name="jenkel" value="Laki-laki" <?php if ($row['jenkel'] == 'Laki-laki') echo 'checked'; ?> required> Laki-laki</label>
                                                    <label><input type="radio" name="jenkel" value="Perempuan" <?php if ($row['jenkel'] == 'Perempuan') echo 'checked'; ?>> Perempuan</label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="tmp_lahir" name="tmp_lahir" required class="form-control special" value="<?php echo $row['tmp_lahir']; ?>">
                                            </td>
                                            <td class="special2">
                                                <table class="uagama">
                                                    <th><label for="no_hp">No. Telp</label></th>
                                                    <td><input type="text" id="no_hp" name="no_hp" required class="form-control nope" value="<?php echo $row['no_hp']; ?>"></td>
                                                </table>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="date" id="tgl_lahir" name="tgl_lahir" required class="form-control special" value="<?php echo $row['tgl_lahir']; ?>">
                                            </td>
                                            <td>
                                                <table class="uagama">
                                                    <th><label for="tgl_masuk">Tanggal Masuk</label></th>
                                                    <td><input type="date" id="tgl_masuk" name="tgl_masuk" required class="form-control" value="<?php echo $row['tgl_masuk']; ?>"></td>
                                                </table>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="alamat" name="alamat" required class="form-control" value="<?php echo $row['alamat']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="p_jawab" name="p_jawab" required class="form-control" value="<?php echo $row['p_jawab']; ?>">
                                    </div>

                                    <table class="tabel">
                                        <tr>
                                            <th><label for="no_hp2">No. Telp</label></th>
                                            <td><input type="text" id="no_hp2" name="no_hp2" required class="form-control special" value="<?php echo $row['no_hp2']; ?>"></td>
                                            <td class="special2">
                                                <table class="uagama">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="alamat2" name="alamat2" required class="form-control" value="<?php echo $row['alamat2']; ?>">
                                    </div>
